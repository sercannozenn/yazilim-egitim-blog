            ...
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li class="active-page">
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a href="tables-basic.html" class="active">Basic</a>
                            </li>
                            <li>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="page-description">
                                    <h1>Tables</h1>
                                    <span>Documentation and examples for opt-in styling of tables (given their prevalent use in JavaScript plugins) with Bootstrap.</span>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="card-description">Using the most basic table markup, here’s how <code>.table</code>-based tables look in Bootstrap.</p>
...
&lt;/table&gt;</code></pre>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="card-description">Use <code>.table-striped</code> to add zebra-striping to any table row within the <code>&lt;tbody&gt;</code>s appear light or dark gray.</p>
                                        <div class="example-container">
                                            <div class="example-content">
...
&lt;/table&gt;</code></pre>
                                        ...
                                        <p class="card-description m-t-md">A <code>&lt;caption&gt;</code> functions like a heading for a table. It helps users with screen readers to find a table and understand what it’s about and decide if they want to read it.</p>
                                        <div class="example-container">
                                            <div class="example-content">
                                                <table class="table">
...
&lt;/table&gt;</code></pre>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="card-description">Use the modifier classes <code>.thead-light</code> or <code>.thead-dark</code> to make <code>&lt;thead&gt;</code>s appear light or dark gray.</p>
                                        <div class="example-container">
                                            <div class="example-content">
                                                <table class="table">
...
&lt;/table&gt;</code></pre>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="card-description">Similar to tables and dark tables, use the modifier classes <code>.table-light</code> or <code>.table-dark</code> to make <code>&lt;thead&gt;</code>s appear light or dark gray.</p>
                                        <div class="example-container">
                                            <div class="example-content">
...
&lt;/table&gt;</code></pre>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="card-description">Border styles, active styles, and table variants are not inherited by nested tables.</p>
                                        <div class="example-container">
                                            <div class="example-content">
...
&lt;/table&gt;</code></pre>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="card-description">Responsive tables allow tables to be scrolled horizontally with ease. Make any table responsive across all viewports by wrapping a <code>.table</code> with <code>.table-responsive</code>.</p>
                                        <div class="example-container">
                                            <div class="example-content">
...
&lt;/div&gt;</code></pre>
                                        ...
                                        <p class="card-description m-t-md">Use <code>.table-responsive{-sm|-md|-lg|-xl|-xxl}</code> as needed to create responsive tables up to a particular breakpoint. From that breakpoint and up, the table will behave normally and not scroll horizontally.</p>
                                        <p class="card-description bold">These tables may appear broken until their responsive styles apply at specific viewport widths.</p>
                                        <div class="example-container">
                                            <div class="example-content">
                                            ...
                                            <div class="example-code">
                                                <pre><code class="html">&lt;div class=&quot;table-responsive-lg&quot;&gt;
    &lt;table class=&quot;table&quot;&gt;
        ...
    &lt;/table&gt;
&lt;/div&gt;</code></pre>
                                        ...
                                        <div class="example-container m-t-md">
                                            ...
                                            <div class="example-code">
                                                <pre><code class="html">&lt;div class=&quot;table-responsive-md&quot;&gt;
    &lt;table class=&quot;table&quot;&gt;
        ...
    &lt;/table&gt;
&lt;/div&gt;</code></pre>
